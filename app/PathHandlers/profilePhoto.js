...
const bucket = cloudStorage.bucket("swifty_profile_photos"); // Set Storage Bucket



async function getProfilePhoto(req, res) {
    //IMPLEMENT: Add catch try block here maybe b/c async...
    ...
    res.type('image/jpeg'); //Eventually we might want to check the mimeType of the actual image but for now its just png
